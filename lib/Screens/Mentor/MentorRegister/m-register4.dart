                        ...
                        onPressed: () {
                          if (_formKey.currentState.validate()) {
                            if (education != null && field != null) {
                              ...
                              _mentorModel.jobDesc = jobDescController.text;
                              _mentorModel.expYears = expController.text;
                              _mentorModel.educationlevel = education;
                              _mentorModel.fieldOfEducation = field;
